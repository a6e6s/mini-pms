<div x-data="{
    ...
    {{-- Title --}}
    <div class="space-y-1">
        <label class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('app.fields.title') }}</label>
    ...
    <div class="grid grid-cols-2 gap-4">
        ...
        {{-- Project --}}
        <div class="space-y-1">
            <label class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('app.fields.project') }}</label>
        ...
        {{-- Status --}}
        <div class="space-y-1">
            <label class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('app.fields.status') }}</label>
    ...
    {{-- Description --}}
    <div class="space-y-1">
        <label class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('app.fields.description') }}</label>
        <div x-show="!editing.description" @click="toggleEdit('description')"
            ...
            <span class="text-gray-900 dark:text-white whitespace-pre-wrapx"
                x-text="formData.description || '{{ __('app.kanban.click_to_add_description') }}'"></span>
        </div>
    ...
    <div class="grid grid-cols-2 gap-4">
        {{-- Due Date --}}
        <div class="space-y-1">
            <label class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('app.fields.due_date') }}</label>
        ...
        {{-- Time Taken --}}
        <div class="space-y-1">
            <label class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('app.fields.time_taken') }}</label>
    ...
    <div class="space-y-1 mb-3">
        <label class="text-sm font-medium badge text-gray-700 dark:text-gray-300">{{ __('app.fields.assigned_user') }}</label>
    ...
    <div class="space-y-3 pt-4 border-t border-gray-200 dark:border-gray-700">
        <h3 class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('app.kanban.comments') }}</h3>
        ...
        @empty
            <p class="text-sm text-gray-500 dark:text-gray-400 italic">{{ __('app.kanban.no_comments_yet') }}</p>
        @endforelse
    </div>
</div>
